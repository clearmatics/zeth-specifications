...
In what follows, \Curve~represents a curve with scalar field $\FFx{\rCURVE}$. Definitions are given in terms of this generic curve, but where appropriate we give examples and notes relating to specific instances. % TODO such as \BNCurve.
