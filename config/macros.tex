...
\newcommand{\apn}{\acrshort{apn}} % Almost Perfect Nonlinear
\newcommand{\ecc}{\acrshort{ecc}} % Elliptic Curve Cryptography
\newcommand{\acrnfs}{\acrshort{nfs}} % \nfs already defined: Number Field Sieve
...
\newcommand{\gsetCURVE}{\ensuremath{\gset_{\constantstyle{CUR}}}\xspace} % Notation for the safe cryptographic elliptic curve group of \Curve
\newcommand{\rCURVE}{\ensuremath{\constantstyle{r_{CUR}}}\xspace} % Prime that defines the scalar field \FFx{\rCURVE} of \Curve
...
\newcommand{\gsetBN}{\ensuremath{\gset_{\constantstyle{BN}}}\xspace} % Notation for the safe cryptographic elliptic curve group of BN254 (the whole curve here, since cofactor = 1)
\newcommand{\pBN}{\ensuremath{\constantstyle{p_{BN}}}\xspace} % Characteristic of the prime (base) field over which BN254 is defined
\newcommand{\rBN}{\ensuremath{\constantstyle{r_{BN}}}\xspace} % Prime order of the group defined by BN254 (characteristic of the scalar field)
...
\newcommand{\pBLS}{\ensuremath{\constantstyle{p_{BLS}}}\xspace} % Characteristic of the prime (base) field over which BLS12-377 is defined
\newcommand{\rBLS}{\ensuremath{\constantstyle{r_{BLS}}}\xspace} % Prime order of the group defined by BLS12-377 (characteristic of the scalar field)
...
\newcommand{\pSecp}{\ensuremath{\constantstyle{p_{SECP}}}\xspace} % Characteristic of the prime (base) field over which secp256k1 is defined
\newcommand{\rSecp}{\ensuremath{\constantstyle{r_{SECP}}}\xspace} % Prime order of the group defined by secp256k1 (characteristic of the scalar field)
%% Zeth constants
