...
\nomenclature[F]{$\pBN$}{Characteritic of the prime (base) finite field over which curve $\BNCurve$ is defined, $\pBN = \seqsplit{21888242871839275222246405745257275088696311157297823662689037894645226208583}$~\cite{bn-prime}}
...
\nomenclature[F]{$\pBLS$}{Characteritic of the prime (base) finite field over which curve $\BLSCurve$ is defined, $\pBLS = \seqsplit{258664426012969094010652733694893533536393512754914660539884262666720468348340822774968888139573360124440321458177}$~\cite{bowe18zexe}}
...
\nomenclature[F]{$\txDefaultGas$}{The default/intrinsic gas cost of an \ethereum~transaction \nomunit{$21 000\, \wei$}}
...
\nomenclature[F]{$\rSecp$}{Characteritic of the scalar field of $\secpCurve$, $\rSecp = \seqsplit{115792089237316195423570985008687907852837564279074904382605163141518161494337}$~\cite{secp256k1}}
